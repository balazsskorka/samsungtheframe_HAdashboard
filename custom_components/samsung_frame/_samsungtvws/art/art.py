...
class SamsungTVArt(SamsungTVWSConnection):
    ...
    def upload(
        ...
        # NOTE: 2019 Frame TV fix — skip the 0.97 WS binary upload path.
        # The 2019 firmware reports API 0.97 but the binary upload fails with
        # error -1. Always use the D2D socket handshake path instead.
